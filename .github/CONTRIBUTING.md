...
* gbeep/gbeep-ecommerce-sdk-php follows the **[PSR-12 coding standard][psr-12]**. Please
  ensure your code does, too.
* Please **write tests** for any new features you add.
* Please **ensure that tests pass** before submitting your pull request.
  gbeep/gbeep-ecommerce-sdk-php has Travis CI automatically running tests for pull requests.
